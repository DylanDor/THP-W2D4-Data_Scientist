...
def question1
twitterlist = data
puts "La liste compte #{twitterlist.length} contacts."
end


def question2
    twitterlist = data
    twitterlist.sort_by!(&:length)
    puts "Le nom le plus court est #{twitterlist[0]}."
end

def question3
    twitterlist = data
    twitterlist.select! {|i| i.length == 6}
    puts "Il y a #{twitterlist.length} handles qui comptiennent 5 caractères."
end

def question4
    twitterlist = data
    puts "Il y a #{twitterlist.grep(/[UPPERCASE]/).length} handles qui commencent par une majuscules."
end

def question5
    twitterlist = data
    puts "Voici la liste classé par ordre alphabétique."
    puts
    sleep 1
    puts twitterlist.sort
end

def question6
    twitterlist = data
    puts "Voici la liste classé par taille de handle."
    puts
    sleep 1
    puts twitterlist.sort_by!(&:length)
end

def question7
    twitterlist = data
    puts "@epenser est le #{twitterlist.index('@epenser')}e handle dans la liste."
end
...
loop do
    puts
    puts "=============================================="
    puts "  BONJOUR ! JE SUIS VOTRE CONSULTANT TWITTER  "
    puts "=============================================="
    sleep 1
    puts
    ...
    puts " 4 : Combien commencent de handle par une majuscule ?"
